...
" Version:      0.1
" Description:  Made for xterm-256 colors terminals. Will use equalent colors
"               for Gvim based on colorshart link below. The theme is a fork
"               of Tim Popes vividchalk.
"
" colorshart: http://www.calmar.ws/vim/256-xterm-24bit-rgb-color-chart.html
...
highlight LineNr term=underline ctermfg=254 ctermbg=234 guifg=#DDEEFF guibg=#1c1c1c
...
" Spell check
highlight SpellBad      cterm=underline ctermbg=NONE ctermfg=DarkRed
highlight SpellRare     cterm=underline ctermbg=NONE ctermfg=DarkMagenta
highlight SpellCap      cterm=underline ctermbg=NONE ctermfg=DarkBlue
highlight SpellLocal    cterm=underline ctermbg=NONE ctermfg=DarkCyan
...
highlight Comment term=bold ctermfg=237 gui=italic guifg=#3A3A3A
" 26 instead?
